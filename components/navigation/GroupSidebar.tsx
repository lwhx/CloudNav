...
const GroupSidebar = ({ groups, activeGroupId, navTitle, open, onClose, onSelect, onManageGroups, footer }: GroupSidebarProps) => (
  <aside className={`fixed inset-y-0 left-0 z-30 flex w-72 flex-col border-r border-slate-200 bg-slate-100/95 shadow-xl backdrop-blur transition-transform duration-300 dark:border-slate-700 dark:bg-slate-950/95 lg:static lg:z-auto lg:w-64 lg:translate-x-0 lg:shadow-none ${open ? 'translate-x-0' : '-translate-x-full'}`} aria-label="一级分类导航">
